...
\begin{enumerate}
	...
	\item In the study guide, I reworded the five principles\marginnote{page 478} of an ecosystem-based management \smallcaps{(emb)} outlined by Halpern and Agardy. What does each of these mean and why is each important for \smallcaps{ebm}:\marginnote{My slide:}
