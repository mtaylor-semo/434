...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{mar_eco_cons_intro}}
\begin{frame}[t]
\end{frame}
}

{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{LV_diving}}
\begin{frame}[t,plain]
\large
\vspace{5ex}
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth]{critical_analyses}}
\begin{frame}
\end{frame}
}

{\usebackgroundtemplate{\includegraphics[width=\paperwidth]{conservation_plan}}
\begin{frame}
\end{frame}
}

{\usebackgroundtemplate{\includegraphics[width=\paperwidth]{textbook}}
\begin{frame}
\end{frame}
}
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth]{barrier_island}}
...
\begin{frame}[t]
	...
	\includegraphics[width=\textwidth]{clam_diggers}
...
\begin{frame}[t]{Ecosystem services provide \highlight{value} that influence human activity.}
	\includegraphics[width=\textwidth]{ecoservices_quantifying_valuation}
\end{frame}
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth]{caribbean_sea}}
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth]{bonaire_ecosystem_services}}
\begin{frame}[b]
