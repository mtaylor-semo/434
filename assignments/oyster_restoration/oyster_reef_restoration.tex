...
\firstpageheader{\textsc{bi} 434: Marine Ecology \amper Conservation}{}{\ifprintanswers\textbf{KEY}\else Name: \enspace \makebox[2in]{\hrulefill}\fi}
...
%\input{oysters_larval_transport}   % First in series.
%\input{oysters_cofoundation}       % Second in series.
%\input{oysters_density_predators}  % Third in series.
%\input{oysters_reef_substrate}     % Fourth in series.
%\input{oysters_fish_catch}         % Fifth in series.
%\input{oysters_nekton_macroinverts} OLD NAME FOR SUBSTRATE I THINK.
